<template>
    <main>
        <div class="row mt-3 text-center m-5">
        ...
        <div class="row mt-3">
            ...
            <div class="col-10">
                <h2 class="text-center text-bg-secondary p-1">1. Datenschutz auf einen Blick</h2>
                <h4>Allgemeine Hinweise</h4>
                <p>
                    Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren
                    personenbezogenen Daten
                    passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen
                    Sie
        ...
        <div class="row mt-3">
            <div class="col"></div>
            <div class="col-10">
                <h2 class="text-center text-bg-secondary p-1">2. Hosting</h2>
        ...
        <div class="row mt-3">
            ...
            <div class="col-10">
                <h2 class="text-center text-bg-secondary p-1">3. Allgemeine Hinweise und Pflichtinformationen</h2>
                <h4>Datenschutz</h4>
                <p>
                ...
                <p>
                    Telefon: +49 (0) 123 44 55 69<br>
                    E-Mail: info@quizius-maximus.de
                </p>
                <p>
                    Verantwortliche Stelle ist die natürliche oder juristische Person, die allein oder gemeinsam mit
                    anderen über
                    die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten (z. B. Namen, E-Mail-Adressen o.
                    Ä.)
                    entscheidet.
                </p>
                <h4>Speicherdauer</h4>
                ...
                <p>
                    ...
                    Übertragung
                    personenbezogener Daten in Drittstaaten erfolgt die Datenverarbeitung außerdem auf Grundlage von
                    Art.
                    ...
                    diese
                    zur Erfüllung einer rechtlichen Verpflichtung erforderlich sind auf Grundlage von Art. 6 Abs. 1 lit.
                    c DSGVO.
                ...
                <p>
                    ...
                    ist teilweise auch eine Übermittlung von personenbezogenen Daten an diese externen Stellen
                    erforderlich.
                    Wir geben personenbezogene Daten nur dann an externe Stellen weiter, wenn dies im Rahmen einer
                    Vertragserfüllung erforderlich ist, wenn wir gesetzlich hierzu verpflichtet sind (z. B. Weitergabe
                    von Daten
                    an Steuerbehörden), wenn wir ein berechtigtes Interesse nach Art. 6 Abs. 1 lit. f DSGVO an der
                    Weitergabe
        ...
        <div class="row mt-3">
            ...
            <div class="col-10">
                <h2 class="text-center text-bg-secondary p-1">4. Datenerfassung auf dieser Website</h2>
