<template>
    <main class="mx-5">
        ...
        <!-- (1) -->
        <div class="row mt-3">
            <h3 class="text-center text-bg-secondary p-1">1. Datenschutz auf einen Blick</h3>
        ...
        <!-- (2) -->
        <div class="row mt-3">
            <h3 class="text-center text-bg-secondary p-1">2. Hosting</h3>
        ...
        <!-- (3) -->
        <div class="row mt-3">
            <h3 class="text-center text-bg-secondary p-1">3. Allgemeine Hinweise und Pflichtinformationen</h3>
            <h4>Datenschutz</h4>
            <p>
        ...
        <!-- (4) -->
        <div class="row mt-3">
            <h3 class="text-center text-bg-secondary p-1">4. Datenerfassung auf dieser Website</h3>
