...
// Steuert ein Themenbasiertes Spiel im Cooperative Mode
...
const GAMEMODE_THEME_COOP = `Kooperativ - Themenbasiertes Quiz - Lektion ${props.section}`;
...
<template>
    <Quiz v-if="isDataFetchCompleted" :questions="questionsData" :game-mode-longtext="GAMEMODE_THEME_COOP"
