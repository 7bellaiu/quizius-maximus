...
const FAQ_CONTENT = ref([
    ...
    },
    {
        ...
        answer4: "<ul><li>Schnelles Quiz</li><li>Themenbasiertes Quiz</li><li>Prüfungssimulation</li></ul>"
    },
    {
        ...
        answer3: "<br>Zur Auswahl stehen dabei:",
        answer4: "<ul><li>Schnelles Quiz</li><li>Themenbasiertes Quiz</li><li>Lernmodus</li></ul>"
    },
    {
