...
<template>
    <div class="accordion-item mb-2">
        ...
        <div id="collapseLegend" class="accordion-collapse collapse bg-info bg-opacity-10">
                ...
                <div class="container">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-9 col-md-11 d-flex align-items-center">
                            <p class="mb-0">
                                kompetitiv (gegeneinander, 1 vs. 1)
                            </p>
                        </div>
                    </div>
                    <!-- coop -->
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-9 col-md-11 d-flex align-items-center">
                            <p class="mb-0">
                                hier gibt es <strong>keinen</strong> kompetitiven Spielmodus (gegeneinander)
                            </p>
                        </div>
                    </div>
                    <!-- kein coop -->
                    <div class="row mb-2">
                        ...
                        <div class="col-9 col-md-11 d-flex align-items-center">
                            <p class="mb-0">
                                hier gibt es <strong>keinen</strong> kooperativen Spielmodus (miteinander)
                            </p>
                        </div>
                    </div>
                    <!-- create FK -->
                    <div class="row mb-2">
                        ...
                        <div class="col-9 col-md-11 d-flex align-items-center">
                            <p class="mb-0">
                                Erstellung eines neuen Fragenkatalogs
                            </p>
                        </div>
                    </div>
                    <!-- display FK -->
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-9 col-md-11 d-flex align-items-center">
                            <p class="mb-0">
                                Frage oder Fragenkatalog löschen
                            </p>
                        </div>
                    </div>
                    <!-- save FK -->
